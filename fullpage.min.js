...
!(function (n, t) {
  ...
  function Tt() {
    if (!bt().anchors.length) {
      var n = p(
        bt().sectionSelector.split(',').join('[data-anchor],') +
          '[data-anchor]',
        ht
      );
      n.length &&
        n.length === p(bt().sectionSelector, ht).length &&
        ((pt = !0),
    ...
    if (!bt().navigationTooltips.length) {
      var t = p(
        bt().sectionSelector.split(',').join('[data-tooltip],') +
          '[data-tooltip]',
        ht
      );
      t.length &&
  ...
  var Mt = function (n) {
    ...
    At = function (n, t) {
      (this.parent = this.parent || null),
        (this.selector = t),
        (this.anchor =
          U(n, 'data-anchor') || bt().anchors[A(n, bt().sectionSelector)]),
        (this.item = n),
        (this.isVisible = d(n)),
        (this.isActive = m(n, Vn)),
        (this.an = m(n, it) || null != p(ot, n)[0]),
        (this.un = t === bt().sectionSelector),
        (this.cn = F(n, tt) || F(n, Nn)),
        (this.index = function () {
  ...
  function Pt(n, t) {
    !bt().autoScrolling || bt().scrollBar || (n.self != window && m(n, Jn))
      ? n.self != window && m(n, Jn)
        ? (n.scrollLeft = t)
        : n.scrollTo(0, t)
      : (n.style.top = t + 'px');
  }
  function zt(n) {
    ...
    return D(n, In), y(n, { '-webkit-transition': t, transition: t });
  }
  function Ct(n, t) {
    var e = n.index(),
      i = A(t, Gn);
  ...
  function It(n) {
    ...
    if (bt().css3 && bt().autoScrolling && !bt().scrollBar)
      Bt('translate3d(0px, -' + t + 'px, 0px)', !1);
    else if (bt().autoScrolling && !bt().scrollBar)
      y(wt(), { top: -t + 'px' }), (f.test.top = -t + 'px');
    else {
      var e = Rt(t);
  ...
  function qt(n, t, e, i) {
    var r,
      a = (function (n) {
        return n.self != o && m(n, Jn)
          ? n.scrollLeft
          : !bt().autoScrolling || bt().scrollBar
            ? H()
            : n.offsetTop;
      })(n),
      u = t - a,
      ...
      l = vn.q;
    dn({ q: !0 }),
      Wt && window.cancelAnimationFrame(Wt),
      (Wt = function (f) {
        r || (r = f);
        var s = Math.floor(f - r);
        if (vn.q) {
          var v = t;
          e && (v = o.fp_easings[bt().easing](s, a, u, e)),
            s <= e && Pt(n, v),
            s < e
              ? window.requestAnimationFrame(Wt)
              : void 0 === i || c || (i(), dn({ q: !1 }), (c = !0));
        } else c || l || (i(), dn({ q: !1 }), (c = !0));
      }),
      window.requestAnimationFrame(Wt);
  }
  function Gt(n) {
    ...
    var e = (function (n, t) {
      var e = {
        afterRender: function () {
          return { section: Gt(hn().F), hn: Kt(hn().F.activeSlide) };
        },
        onLeave: function () {
          return {
  ...
  function oe(n) {
    V(n), dn({ N: 'horizontalNav' });
    var t = F(this, Gn),
      e = p(Zn, F(this, Gn))[0],
      i = Ot(hn().C, t).slides[A(F(this, 'li'))];
    sn.D(kn, { slides: e, destination: i.item });
  }
  var re,
    ae = {};
  function ue(n, t, e) {
  ...
  function le() {
    var n = F(this, Gn);
    m(this, ft)
      ? ce().m.left && (dn({ N: 'slideArrow' }), sn.D(mn, { section: n }))
      : ce().m.right && (dn({ N: 'slideArrow' }), sn.D(wn, { section: n }));
  }
  function fe() {
    clearTimeout(re), dn({ H: !1 });
  }
  function se(n, t, e) {
    var i,
      o,
    ...
    (c.pn =
      ...
      (c.direction = c.direction ? c.direction : c.pn),
      c.localIsResizing || dn({ G: !1 }),
      bt().onSlideLeave &&
      !c.localIsResizing &&
      'none' !== c.pn &&
      Y(bt().onSlideLeave) &&
      !1 === Yt('onSlideLeave', c)
        ...
        : (L(t, Vn),
          D(W(t), Vn),
          qe(),
          c.localIsResizing || (Xt(c.prevSlide), Jt(t)),
          (function (n) {
            !bt().loopHorizontal &&
              bt().controlArrows &&
              (X(p(st, n.section), 0 !== n.slideIndex),
              X(p(vt, n.section), null != T(n.destiny)));
          })(c),
          a.isActive &&
            !c.localIsResizing &&
            te(c.slideIndex, c.slideAnchor, c.anchorLink),
          (function (n, t, e) {
            var i,
              o,
              r = t.destinyPos;
            if (
              ...
              bt().slidesNavigation &&
                null != i &&
                (D(p(Un, i), Vn), L(p('a', p('li', i)[o]), Vn)),
              dn({ scrollX: Math.round(r.left) }),
              bt().css3)
            ) {
              var a = 'translate3d(-' + Math.round(r.left) + 'px, 0px, 0px)';
              (f.test.gn[t.sectionIndex] = a),
                y(zt(p(tt, n)), Nt(a)),
                clearTimeout(re),
              ...
              (f.test.left[t.sectionIndex] = Math.round(r.left)),
                qt(n, Math.round(r.left), bt().scrollingSpeed, function () {
                  de(t);
                });
          })(n, c));
  }
  ...
  function de(n) {
    n.localIsResizing ||
      (Y(bt().afterSlideLoad) && Yt('afterSlideLoad', n),
      dn({ G: !0 }),
      $t(n.destiny),
      sn.D(Rn, n)),
      dn({ H: !1 });
  ...
  function ge(n, t) {
    ...
    if (bt().autoScrolling && !bt().scrollBar)
      y(_t, { overflow: 'hidden', height: '100%' }),
        D(Vt, 'fp-scrollable'),
        pe(yt().recordHistory, 'internal'),
        y(wt(), { '-ms-touch-action': 'none', 'touch-action': 'none' }),
        null != e && It(e.offsetTop);
    else if (
      (y(_t, { overflow: 'visible', height: 'initial' }),
      L(Vt, 'fp-scrollable'),
      pe(!!bt().autoScrolling && yt().recordHistory, 'internal'),
      y(wt(), { '-ms-touch-action': '', 'touch-action': '' }),
      null != e)
    ) {
  ...
  function me() {
    var n =
      p('.fp-auto-height')[0] || (Fe() && p('.fp-auto-height-responsive')[0]);
    bt().lazyLoading &&
      n &&
  ...
  function be() {
    ...
    var e = p(Yn)[0];
    L(e, 'fp-' + bt().navigationPosition),
      bt().showActiveTooltip && L(e, 'fp-show-active');
    for (var i = '', o = 0; o < hn().C.length; o++) {
      var a = hn().C[o],
        u = '';
      bt().anchors.length && (u = a.anchor),
        (i +=
          '<li><a href="#' +
          encodeURI(u) +
  ...
  function ye(n) {
    n.preventDefault && V(n), dn({ N: 'verticalNav' });
    var t = A(F(this, '#fp-nav li'));
    sn.D(jn, { destination: hn().C[t] });
  }
  function Se(n, t) {
    var e;
    (e = n),
      bt().menu &&
        bt().menu.length &&
        p(bt().menu).forEach(function (n) {
          null != n &&
            (D(p(Un, n), Vn), L(p('[data-menuanchor="' + e + '"]', n), Vn));
        }),
      (function (n, t) {
        var e = p(Yn)[0];
        bt().navigation &&
          ...
          (D(p(Un, e), Vn),
          L(n ? p('a[href="#' + n + '"]', e) : p('a', p('li', e)[t]), Vn));
      })(n, t);
  }
  (ae.m = { up: !0, down: !0, left: !0, right: !0 }),
    (ae.k = g({}, ae.m)),
    sn.L(gn, function (n) {
      var t = n.target;
      (Q(t, lt) || F(t, lt)) && le.call(t, n);
    }),
    (f.landscapeScroll = se),
    sn.L(yn, function () {
      sn.L(Dn, fe);
    }),
    (f.setRecordHistory = pe),
    (f.setAutoScrolling = ge),
    (f.test.setAutoScrolling = ge),
    new Date().getTime();
  var Te,
    Me,
    Ae,
    ...
    if (null != i) {
      var o,
        ...
        u = {
          ...
          localIsResizing: vn.W,
          items: { origin: hn().F, destination: n },
          direction: null,
        };
      if (
        !(
          (hn().F.item == i && !vn.W) ||
          (bt().scrollBar && H() === u.dtop && !m(i, 'fp-auto-height'))
        )
      ) {
        if (
          (null != u.activeSlide &&
          ...
          if (
            ...
            (u.direction = c),
            Y(bt().beforeLeave) && !1 === Le('beforeLeave', u))
          )
            return;
          if (Y(bt().onLeave) && !Yt('onLeave', u)) return;
        }
        bt().autoScrolling &&
          bt().continuousVertical &&
          ...
          (u = (function (n) {
            ...
            var t = hn().F.item;
            return (
              n.isMovementUp ? B(t, tn(t, Gn)) : N(t, en(t, Gn).reverse()),
              It(hn().F.item.offsetTop),
              (function () {
              ...
              (n.yMovement = Ct(hn().F, n.element)),
              n
            );
          })(u)),
          u.localIsResizing || Xt(hn().F.item),
          L(i, Vn),
          D(W(i), Vn),
          qe(),
          Jt(i),
          ...
          (function (n) {
            ...
            if (
              (dn({ K: 'none', scrollY: Math.round(n.dtop) }),
              sn.D(Dn),
              bt().css3 && bt().autoScrolling && !bt().scrollBar)
            )
              Bt('translate3d(0px, -' + Math.round(n.dtop) + 'px, 0px)', !0),
                bt().scrollingSpeed
                  ? (clearTimeout(Oe),
                    (Oe = setTimeout(function () {
                      Ee(n), dn({ G: !t || f.test.wn });
                    }, bt().scrollingSpeed)))
                  : Ee(n);
            else {
              var i = Rt(n.dtop);
              (f.test.top = -n.dtop + 'px'),
                clearTimeout(Oe),
                qt(i.element, i.options, bt().scrollingSpeed, function () {
                  bt().scrollBar
                    ? (Oe = setTimeout(function () {
                        Ee(n);
                      }, 30))
  ...
  function Ee(n) {
    dn({ B: !1 }),
      ...
      Y(bt().afterLoad) && !n.localIsResizing && Yt('afterLoad', n),
      qe(),
      n.localIsResizing || $t(n.element),
      L(n.element, _n),
      D(W(n.element), _n),
      me(),
      Ve.bn(),
  ...
  function Ce(n) {
    ...
    n
      ? t ||
        ...
        O(p(Yn)),
        L(Vt, Bn),
        Y(bt().afterResponsive) && bt().afterResponsive.call(wt(), n))
      : t &&
        (ge(yt().autoScrolling, 'internal'),
        Re(yt().autoScrolling, 'internal'),
        j(p(Yn)),
        D(Vt, Bn),
        Y(bt().afterResponsive) && bt().afterResponsive.call(wt(), n));
  }
  ...
  function Ne(n) {
    bt().verticalCentered &&
      ((!bt().scrollOverflow && Ve.yn(n.item)) ||
        Ve.Sn(n) ||
        m(n.item, et) ||
        L(n.item, et));
  }
  ...
  function Ie(n) {
    var t = n.item,
      e = n.Tn.length,
      i = n.index();
    !hn().F && n.isVisible && (L(t, Vn), qe()),
      (Be = hn().F.item),
      bt().paddingTop && y(t, { 'padding-top': bt().paddingTop }),
      bt().paddingBottom && y(t, { 'padding-bottom': bt().paddingBottom }),
      void 0 !== bt().sectionsColor[i] &&
        y(t, { 'background-color': bt().sectionsColor[i] }),
      void 0 !== bt().anchors[i] && t.setAttribute('data-anchor', n.anchor),
      e || Ne(n);
  }
  function He() {
  ...
  var We,
    Ve = {
      ...
      Mn: function () {
        bt().scrollOverflowMacStyle && !u && L(Vt, 'fp-scroll-mac'),
          hn().vn.forEach(function (n) {
            if (
              !(
                (n.slides && n.slides.length) ||
                (m(n.item, 'fp-auto-height-responsive') && Fe())
              )
            ) {
              var t,
                e = Dt(n.item),
      ...
      Dn: function (n) {
        Ve.kn(n).addEventListener('scroll', Ve.En),
          n.addEventListener('wheel', Ve.jn, { passive: !1 }),
          n.addEventListener('keydown', Ve.jn, { passive: !1 });
      },
      Ln: function (n) {
      ...
      Pn: function (n, t) {
        ...
        var e = Ve.kn(t);
        if (!bt().scrollOverflow || !m(e, it) || m(Dt(t), 'fp-noscroll'))
          return !0;
        var i = l ? 1 : 0,
          o = e.scrollTop,
          r = 'up' === n && o <= 0,
      ...
      En:
        ...
        function (n) {
          ...
          (We = t),
            Y(bt().onScrollOverflow) &&
              Yt('onScrollOverflow', { position: t, direction: e }),
            m(n.target, it) &&
              vn.G &&
              Ve.Pn(e, n.target) &&
              Ve.zn() &&
    ...
    (vn.F = null),
      ...
      (function () {
        ...
        if (!n && vn.C.length && !hn().B && Ue) {
          var i = Ye(Ue, vn.C);
          i && ((vn.F = i), (vn.F.isActive = !0), L(vn.F.item, Vn)),
            vn.F && It(vn.F.item.offsetTop);
        }
        if (t && !e && _e) {
          var o = Ye(_e, vn.F.slides);
          o &&
            ((vn.F.activeSlide = o),
            (vn.F.activeSlide.isActive = !0),
            L(vn.F.activeSlide.item, Vn)),
            vn.F.activeSlide && he(vn.F.activeSlide.item, 'internal');
        }
      })();
  }
  function Ge() {
    ...
    (Ue = Ke(vn.F)),
      (_e = Ke(vn.F ? vn.F.activeSlide : null)),
      (vn.R = t.length),
      (vn.P = i.reduce(function (n, t) {
        return n + t.slides.length;
      }, 0)),
      (vn.C = i),
      (vn.ln = e),
      (vn.slides = o),
      (vn.vn = vn.C.concat(vn.slides));
  }
  function Ke(n) {
    if (!n) return null;
    var t = n ? n.item : null,
  ...
  var $e = function (n) {
    var t = this;
    [].push.call(arguments, bt().sectionSelector),
      At.apply(this, arguments),
      (this.Tn = p(bt().slideSelector, n)),
      (this.Cn = Array.from(this.Tn).map(function (n) {
        return new Xe(n, t);
      })),
  ...
  function Ze(n) {
    ...
    y(p(tt, n.item), { width: o + '%' }),
      ...
      i.forEach(function (n) {
        y(n.item, { width: a + '%' }), bt().verticalCentered && Ne(n);
      });
    var l = n.activeSlide || null;
    null != l &&
    vn.F &&
    (0 !== vn.F.index() || (0 === vn.F.index() && 0 !== l.index()))
      ? he(l.item, 'internal')
      : L(e[0], Vn);
  }
  (Xe.prototype = At.prototype), (Xe.prototype.constructor = $e);
  var ni = { attributes: !1, subtree: !0, childList: !0, characterData: !0 };
  function ti() {
    return h(p(bt().slideSelector, wt())).length !== hn().P;
  }
  function ei(n) {
    var t = ti();
    (ti() || h(p(bt().sectionSelector, wt())).length !== hn().R) &&
      !vn.en &&
      (bt().observer && Qe && Qe.disconnect(),
      Ge(),
      qe(),
      (bt().anchors = []),
      Z(p(Yn)),
  ...
  function fi() {
    var n = bt().css3
        ? H() + w()
        : rn(hn().C).item.offsetTop + rn(hn().C).item.offsetHeight,
      t = Rt(n);
    (f.test.top = -n + 'px'),
      dn({ G: !1 }),
  ...
  function mi() {
    var n = hn().F.next();
    n || (!bt().loopBottom && !bt().continuousVertical) || (n = hn().C[0]),
      null != n
        ? De(n, null, !1)
        : wt().scrollHeight < Vt.scrollHeight && sn.D(Ln);
  }
  function wi() {
    var n = hn().F.prev();
    n || (!bt().loopTop && !bt().continuousVertical) || (n = rn(hn().C)),
      null != n && De(n, null, !0);
  }
  ...
  function yi(n) {
    bt().autoScrolling &&
      (vn.G &&
        (n.pageY < bi && ce().m.up
          ? wi()
          : n.pageY > bi && ce().m.down && mi()),
      (bi = n.pageY));
  }
  function Si(n) {
    if (ce().m[n]) {
      var t = 'down' === n ? mi : wi;
      bt().scrollOverflow && Ve.Sn(hn().F)
        ? Ve.Pn(n, hn().F.item) && Ve.zn() && t()
        : t();
    }
  }
  var Ti,
    ...
    Li = 0,
    Di =
      (o.PointerEvent && (xi = { down: 'pointerdown', move: 'pointermove' }),
      xi),
    Ei = {
  ...
  function Ri(n) {
    ...
    if (Pi(n)) {
      ...
      var r = Math.abs(Oi - ki) > (o.innerHeight / 100) * bt().touchSensitivity,
        ...
        c = Oi > ki ? 'down' : 'up';
      dn({ K: u ? (ji > Li ? 'right' : 'left') : c }),
        u
          ? !vn.H &&
            a &&
            (ji > Li
              ? ce().m.right && sn.D(wn, { section: t })
              : ce().m.left && sn.D(mn, { section: t }))
  ...
  function zi(n) {
    if ((bt().fitToSection && dn({ q: !1 }), Pi(n))) {
      var t = Fi(n);
      (Oi = t.y), (ji = t.x);
    }
    q('touchend', Ci);
  ...
  function Gi(n) {
    ...
    9 === e
            ...
            if (c || (!t && u)) {
              ...
              var l = (function (n) {
                  var t,
                    ...
                    i = [],
                    o = Et(
                      (vn.F && vn.F.activeSlide ? vn.F.activeSlide : vn.F)[e]()
                    );
                  do {
                    (i = Ji(o.item)).length &&
                      (t = { Vn: o, Un: i[n ? i.length - 1 : 0] }),
                      (o = Et(o[e]()));
                  } while (o && 0 === i.length);
                  return t;
                })(c),
      ...
      : Q((t = r.activeElement), 'textarea') ||
        Q(t, 'input') ||
        Q(t, 'select') ||
        'true' == U(t, 'contentEditable') ||
        '' == U(t, 'contentEditable') ||
        !bt().keyboardScrolling ||
        !o ||
        ((Ti = n.ctrlKey),
        (Mi = setTimeout(function () {
          !(function (n) {
            ...
            if (
              ...
              switch ((dn({ N: 'keydown' }), n.keyCode)) {
                case 38:
                case 33:
                  ce().k.up && o && (vn.B ? sn.D(xn, { e: n }) : wi());
                  break;
                case 32:
                  if (t && ce().k.up && !i && o) {
                    wi();
    ...
    n
      ? ((function () {
          ...
          var e =
            ...
            i = oi();
          'DOMMouseScroll' == e
            ? r[n](t + 'MozMousePixelScroll', eo, i)
            : r[n](t + e, eo, i);
        })(),
        wt().addEventListener('mousedown', io),
        wt().addEventListener('mouseup', oo))
      : (r.addEventListener
          ? (G('mousewheel', eo, !1),
            G('wheel', eo, !1),
            G('MozMousePixelScroll', eo, !1))
          : r.detachEvent('onmousewheel', eo),
        wt().removeEventListener('mousedown', io),
        wt().removeEventListener('mouseup', oo));
  }
  function eo(n) {
    var t = new Date().getTime(),
      ...
      i = (function (n, t) {
        new Date().getTime();
        var e =
            hn().B && n.getBoundingClientRect().bottom >= 0 && 'up' === li.Bn(),
          i = hn().In;
        if (i) return V(t), !1;
        if (hn().B) {
          if (e) {
            var o;
            if (!(i || (gi('isNewKeyframe', 'beyondFullpage') && li.Nn())))
              return (
                (o = Rt(
                  rn(hn().C).item.offsetTop + rn(hn().C).item.offsetHeight
            ...
            if (li.Nn())
              return (
                (e = !1), dn({ In: !0 }), dn({ N: 'wheel' }), vi(), V(t), !1
              );
          } else gi('set', 'beyondFullpage', 1e3);
          if (!i && !e) return !0;
        }
      })(wt(), n);
    if ((vn.J || dn({ X: !1, J: !0, K: 'none' }), !ce().m.down && !ce().m.up))
      return V(n), !1;
    if (i) return !0;
    if (!1 === i) return V(n), !1;
    if (bt().autoScrolling && !Ti && !e) {
      ...
      return (
        ...
        vn.G &&
          an(no, 10) >= an(no, 70) &&
          c &&
          (dn({ N: 'wheel' }), Si(a < 0 ? 'down' : 'up')),
        !1
      );
    }
    bt().fitToSection && dn({ q: !1 });
  }
  function io(n) {
    var t;
    2 == n.which &&
      ((t = n.pageY), (bi = t), wt().addEventListener('mousemove', yi));
  }
  function oo(n) {
    ...
    n
      ? (to(!0),
        (function () {
          if (Ei.Hn && (a || c)) {
            bt().autoScrolling &&
              (Vt.removeEventListener(Ei.Hn, Ni, { passive: !1 }),
              Vt.addEventListener(Ei.Hn, Ni, { passive: !1 }));
            var n = bt().touchWrapper;
            n.removeEventListener(Ei.Wn, zi),
              n.removeEventListener(Ei.Hn, Ri, { passive: !1 }),
              n.addEventListener(Ei.Wn, zi),
              n.addEventListener(Ei.Hn, Ri, { passive: !1 });
          }
        })())
      : (to(!1),
        (function () {
          if (Ei.Hn && (a || c)) {
            bt().autoScrolling &&
              (Vt.removeEventListener(Ei.Hn, Ri, { passive: !1 }),
              Vt.removeEventListener(Ei.Hn, Ni, { passive: !1 }));
            var n = bt().touchWrapper;
            n.removeEventListener(Ei.Wn, zi),
              n.removeEventListener(Ei.Hn, Ri, { passive: !1 });
            ...
            .forEach(function (n) {
              if (!e) {
                var t = Q(i, n),
                  o = F(i, n);
                (t || o) &&
                  (f.shared.qn || ro(!1), (f.shared.qn = !0), (e = !0));
              }
            }),
          !e && f.shared.qn && (ro(!0), (f.shared.qn = !1))))
      : ro(!0);
  }
  function fo(n, t) {
  ...
  function wo() {
    go ||
      (((bt().autoScrolling && !bt().scrollBar) || !bt().fitToSection) &&
        yo(w())),
      (function () {
        if (a)
          for (var n = 0; n < 4; n++)
      ...
      (so = setTimeout(function () {
        !(function () {
          if (
            ...
            (e = w()),
              (i = b()),
              (vn.tn === e && po === i) || (dn({ tn: e }), (po = i), bo(!0));
          var e, i;
          dn({ W: !1 });
        })(),
          (go = !1);
  ...
  function bo(n) {
    if (!m(wt(), Hn)) {
      ...
      vn.B || (a && fo(a + 1)),
        ...
        Y(bt().afterResize) &&
          n &&
          bt().afterResize.call(wt(), o.innerWidth, o.innerHeight),
        Y(bt().afterReBuild) && !n && bt().afterReBuild.call(wt()),
        $(wt(), 'afterRebuild');
    }
  }
  function yo(n) {
  ...
  function Mo() {
    if (!vn.V && !bt().lockAnchors) {
      ...
      t &&
        t.length &&
        ((t && t !== vn.U && !i) || o || (!vn.H && vn._ != e)) &&
        sn.D(An, { _n: t, slideAnchor: e });
    }
  }
  function Ao(n) {
    var t = n.target;
  ...
  function xo(n) {
    dn({ N: 'menu' }),
      !p(bt().menu)[0] ||
        (!bt().lockAnchors && bt().anchors.length) ||
        (V(n), sn.D(On, { anchor: U(this, 'data-menuanchor') }));
  }
  function Oo(n) {
    var t = n.target;
    t && F(t, '#fp-nav a')
      ...
      : Q(t, '.fp-tooltip')
        ? we.call(t)
        : (Q(t, ut) || null != F(t, ut)) && oe.call(t, n.e);
  }
  (f.reBuild = bo),
    sn.L(yn, function () {
  ...
  function Do(n) {
    ...
    if (
      ...
      hn().F &&
      (rn(hn().C),
      !hn().B && !hn().In && (!bt().autoScrolling || bt().scrollBar))
    ) {
      var a = H(),
        u = (function (n) {
          var t = n > Lo ? 'down' : 'up';
          return (Lo = n), dn({ nn: n }), t;
        })(a),
        c = 0,
        l = a + w() / 2,
        f = Vt.scrollHeight - w() === a,
        s = hn().C;
      if ((dn({ scrollY: a }), f)) c = s.length - 1;
      else if (a)
        for (var v = 0; v < s.length; ++v) s[v].item.offsetTop <= l && (c = v);
      else c = 0;
      if (
        ((i = u),
        (o = hn().F.item.offsetTop),
        (r = o + w()),
        ('up' == i ? r >= H() + w() : o <= H()) &&
          (m(hn().F.item, _n) || (L(hn().F.item, _n), D(W(hn().F.item), _n))),
        (e = (t = s[c]).item),
        !t.isActive)
      ) {
        dn({ V: !0 });
        var d,
          ...
          M = {
            ...
            leavingSection: g,
            direction: b,
            items: { origin: hn().F, destination: t },
          };
        T && ((h = T.anchor), (d = T.index())),
          vn.G &&
            (L(e, Vn),
            D(W(e), Vn),
            Y(bt().beforeLeave) && Le('beforeLeave', M),
            Y(bt().onLeave) && Yt('onLeave', M),
            Y(bt().afterLoad) && Yt('afterLoad', M),
            Xt(p),
            Jt(e),
            $t(e),
            Se(y, S - 1),
            bt().anchors.length && dn({ U: y }),
            te(d, h, y),
            qe()),
          clearTimeout(jo),
  ...
  function Ro(n) {
    var t = n.index();
    void 0 !== bt().anchors[t] && n.isActive && Se(bt().anchors[t], t),
      bt().menu &&
        bt().css3 &&
        null != F(p(bt().menu)[0], Nn) &&
        p(bt().menu).forEach(function (n) {
          Vt.appendChild(n);
        });
  }
  function Po() {
    ...
    L(i, _n),
      ...
      $t(i),
      (t = Wi((n = So()).section)),
      (n.section && t && (void 0 === t || t.index() !== A(Be))) ||
        !Y(bt().afterLoad) ||
        Yt('afterLoad', {
          F: i,
          element: i,
          ...
          items: { origin: hn().F, destination: hn().F },
        }),
  ...
  function Fo() {
    Ge(),
      qe(),
      (bt().scrollBar = bt().scrollBar || bt().hybrid),
      Tt(),
      (function () {
        y(cn(wt(), 'body'), { height: '100%', position: 'relative' }),
          L(wt(), Fn),
          L(Ut, Wn),
          dn({ tn: w() }),
          D(wt(), Hn),
        ...
        for (var n = hn().ln, t = 0; t < n.length; t++) {
          var e = n[t],
            i = e.Tn;
          e.item.setAttribute('data-fp-styles', U(e.item, 'style')),
            Ie(e),
            Ro(e),
            i.length > 0 && Ze(e);
        }
        bt().fixedElements &&
          bt().css3 &&
          p(bt().fixedElements).forEach(function (n) {
            Vt.appendChild(n);
          }),
          bt().navigation && be(),
          p('iframe[src*="youtube.com/embed/"]', wt()).forEach(function (n) {
            var t, e;
            (e = U((t = n), 'src')),
              t.setAttribute(
                'src',
      ...
      zo(!0),
      ro(!0),
      ge(bt().autoScrolling, 'internal'),
      ze(),
      Zt(),
      'complete' === r.readyState && Co(),
      q('load', Co),
      Po(),
      Ge(),
      qe();
  ...
  function No() {
    ...
    '' === bt().licenseKey.trim()
      ...
      : (bt() && vn.Kn) || r.domain.indexOf('alvarotrigo.com') > -1
        ? n && n.length
        : (v(
            'error',
      ...
      m(Ut, Wn)
        ...
        : (bt().continuousVertical &&
            (bt().loopTop || bt().loopBottom) &&
            ((bt().continuousVertical = !1),
            v(
              'warn',
              'Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled'
            )),
          !bt().scrollOverflow ||
            (!bt().scrollBar && bt().autoScrolling) ||
            v(
              'warn',
      ...
      return (
        ...
        (f.test = Object.assign(f.test, {
          ...
          gn: (function () {
            for (
              var n = [], t = 0;
              t < p(bt().sectionSelector, wt()).length;
              t++
            )
        ...
        (f.shared = Object.assign(f.shared, { Yn: null, qn: !1 })),
        (o.fullpage_api = f),
        wt() && (sn.D('beforeInit'), Fo(), sn.D(yn)),
        o.fullpage_api
      );
    No();
  }
  return (
    ...
    sn.L(yn, function () {
      q('scroll', Do),
        r.body.addEventListener('scroll', Do),
        sn.L(An, function (n) {
      ...
      sn.L(bn, function () {
        ...
        dn({
          Kn:
            ...
            ((u || c) &&
              ((bt().credits && u && e <= u.$n && u.Xn === t.split(n[0])[4]) ||
                c ||
                u.Qn)) ||
              !1),
        });
    ...
    (f.setKeyboardScrolling = Eo),
    (f.shared.Yn = Po),
    (f.setAllowScrolling = zo),
    (f.destroy = function (n) {
      ge(!1, 'internal'),
        ...
        n &&
          ...
          y(xt(hn().C), { height: '', 'background-color': '', padding: '' }),
          y(xt(hn().slides), { width: '' }),
          y(wt(), {
            height: '',
            position: '',
            '-ms-touch-action': '',
          ...
          y(_t, { overflow: '', height: '' }),
          D(Ut, Wn),
          D(Vt, Bn),
          Vt.className.split(/\s+/).forEach(function (n) {
            0 === n.indexOf('fp-viewing') && D(Vt, n);
          }),
          xt(hn().vn).forEach(function (n) {
            bt().scrollOverflow && Ve.Rn(n),
              D(n, 'fp-table active ' + _n),
              U(n, 'data-fp-styles') &&
                n.setAttribute('style', U(n, 'data-fp-styles')),
              m(n, qn) && !pt && n.removeAttribute('data-anchor');
          }),
          Ft(wt()),
          [Kn, tt, Zn].forEach(function (n) {
            p(n, wt()).forEach(function (n) {
              C(n);
            });
          }),
          y(wt(), { '-webkit-transition': 'none', transition: 'none' }),
          o.scrollTo(0, 0),
          [qn, $n, nt].forEach(function (n) {
            D(p('.' + n), n);
          }));
    }),
