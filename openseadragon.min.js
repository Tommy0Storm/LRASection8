...
!(function (c) {
    ...
    u[this.hash] = {
      ...
      gotpointercapture: function (e) {
        !(function (e, t) {
          ...
          H(e, i);
          t.target === e.element && z(e, { id: t.pointerId, type: v(t) }, !0);
          i.stopPropagation && c.stopEvent(t);
        })(i, e);
      },
      lostpointercapture: function (e) {
        !(function (e, t) {
          ...
          H(e, i);
          t.target === e.element && z(e, { id: t.pointerId, type: v(t) }, !1);
          i.stopPropagation && c.stopEvent(t);
        })(i, e);
      },
  ...
  function I(e, t) {
    ...
    n.preventDefault && !n.defaultPrevented && c.cancelEvent(t);
    n.stopPropagation && c.stopEvent(t);
    n.shouldReleaseCapture && (t.target === e.element ? g(e, i) : z(e, i, !1));
  }
  function O(e, t) {
    B(e, t);
  }
      ...
      bindSequenceControls: function () {
        ...
        if (this.showSequenceControl) {
          ...
          this.previousButton = new m.Button({
            ...
            srcRest: H(this.prefixUrl, r.previous.REST),
            srcGroup: H(this.prefixUrl, r.previous.GROUP),
            srcHover: H(this.prefixUrl, r.previous.HOVER),
            srcDown: H(this.prefixUrl, r.previous.DOWN),
            onRelease: n,
            onFocus: e,
            onBlur: t,
          });
          this.nextButton = new m.Button({
            ...
            srcRest: H(this.prefixUrl, r.next.REST),
            srcGroup: H(this.prefixUrl, r.next.GROUP),
            srcHover: H(this.prefixUrl, r.next.HOVER),
            srcDown: H(this.prefixUrl, r.next.DOWN),
            onRelease: i,
            onFocus: e,
            onBlur: t,
          });
  ...
  l.Overlay.prototype = {
    ...
    drawHTML: function (e, t) {
      ...
      if (i.parentNode !== e) {
        ...
        this.size = l.getElementSize(this.elementWrapper);
      }
    ...
    _getSizeInPixels: function (e) {
      ...
      if (this.checkResize && (null === this.width || null === this.height)) {
        n = this.size = l.getElementSize(this.elementWrapper);
        null === this.width && (t = n.x);
        null === this.height && (i = n.y);
      }
...
!(function (w) {
  const a = w;
  a.WebGLDrawer = class extends a.DrawerBase {
    constructor(e) {
      super(e);
      this._destroyed = !1;
    ...
    draw(e) {
      let v = this._gl;
      var t = this.viewport.getBoundsNoRotateWithMargins(!0);
      let i = t,
        n = new a.Point(t.x + t.width / 2, t.y + t.height / 2),
        r = (this.viewport.getRotation(!0) * Math.PI) / 180;
      var o = this.viewport.flipped ? -1 : 1;
      t = w.Mat3.makeTranslation(-n.x, -n.y);
      let s = w.Mat3.makeScaling((2 / i.width) * o, -2 / i.height);
      o = w.Mat3.makeRotation(-r);
      let f = s.multiply(o).multiply(t);
        ...
        if (s.isTainted()) {
          ...
          if (0 !== o.length && 0 !== s.getOpacity()) {
            ...
            if (a) {
              ...
              v.vertexAttribPointer(
                this._secondPass.aOutputPosition,
                2,
                v.FLOAT,
                !1,
                0,
    ...
    setImageSmoothingEnabled(e) {
      if (this._imageSmoothingEnabled !== e) {
        this._imageSmoothingEnabled = e;
        this._unloadTextures();
